...
with tempfile.TemporaryDirectory(prefix='wb-ui-prefs-') as home:
    ...
    try:
        ...
        # Back row is y=15 after sticky reserved row is added.
        mouse(fd,0,10,15);read_until(fd,data,b'Desktop')
        ...
        mouse(fd,0,10,9);read_until(fd,data,b'Disabled');mouse(fd,0,10,15);read_until(fd,data,b'Desktop')
